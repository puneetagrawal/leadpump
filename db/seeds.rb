...
DiscountsOnPeriod.create(periodType:'annually', discountPercentage:17)
...
Plan.create(name:"Advanced",price:31, user_position:"Manage a Team, Track Sales", number_of_user:10, lead_management:"1000",appointment_sheduler:"unlimited",lead_dashboard:true,team_management:true,daily_sales_report:true,daily_sales_projection:true,full_dashboard_enabled:true,traditional_referrals:true,leadpump_social_inviter:false,social_referrals:"",online_mall:false,daily_team_usage_report:false,unlimited_team_training:false,national_spokeswoman:false,online_membership:false)
Plan.create(name:"Professional",price:51, user_position:"Generate Maximum Referrals", number_of_user:10, lead_management:"unlimited",appointment_sheduler:"unlimited",lead_dashboard:true,team_management:true,daily_sales_report:true,daily_sales_projection:true,full_dashboard_enabled:true,traditional_referrals:true,leadpump_social_inviter:true,social_referrals:"unlimited",online_mall:true,daily_team_usage_report:true,unlimited_team_training:false,national_spokeswoman:false,online_membership:false)
